               ...
               <div class="sb-contact-section">
                  <nav aria-label="breadcrumb">
                     ...
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page">Apropos</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="row plr-50">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="sb-team-section">
                  <h6 class="home1-section-heading1">Apropos de <b>SIGIM</b></h6>
            ...
            <div class="apropos">
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                  <div class="about-content">
                     <h5 class="mb-3"><b>Les soins médicaux dans leurs pleine mesure</b></h5>
                     <p class="py-3">
                        It is a long established fact that a reader will be distracted by the readable content of a
                        page when looking at its layout. The point of using Lorem Ipsum is that it has a
                        more-or-less normal distribution of letters, as opposed to using 'Content here, content
                        here', making it look like readable English.The point of using Lorem Ipsum is that it has a
                        more-or-less normal distribution of letters, as opposed to using 'Content here, content
               ...
               <div class="col-lg-6 col-md-12">
                  <div class="image-section ps-rel ">
                     <div class="about-box float_left ptb-100 pt-0">
                           <div class="container">
                              <div class="row">
                                 <div class="col-md-6">
                                       <div class="sb-about-box">
                                          <span><b>01</b></span>
                                          <h6 class="mb-3">Notre Histoire</h6>
                                 ...
                                 <div class="col-md-6">
                                       <div class="sb-about-box">
                                          <span><b>02</b></span>
                                          <h6 class="mb-3">Notre Mission</h6>
                                          <p>It is a long established fact that a reader
                                             will be distracted by the readable the
                                             content of a page when looking.
                                          </p>
         ...
         <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
               <div class="count-up">
                  ...
                  <p class="mb-3">Patient Heureux</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
               <div class="count-up">
                  ...
                  <p class="mb-3">Hopitals Partenaires</p>
               </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
               <div class="count-up">
         ...
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="page-2-heading">
                  <h4>
                     Rencontrer<span> Notre équipe</span>
                  </h4>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
               <div class="sb-founder-section pt-5">
                  <img src="../asset/../asset/images/founder-img1.png" alt="img">
                  <section>
                     <div class="sb-service-section2 bg-change2">
                        <h6>Mr. Joel KOUAME</h6>
                        <p>Développeur FrontEnd</p>
                     </div>
                     <div class="hover-type">
                        <a href="https://www.linkedin.com/in/joel-kouame-346358226/" class="d-inline-block w-100 text-center">Voir le profil</a>
                     </div>
                  </section>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
               <div class="sb-founder-section pt-5">
                  <img src="../asset/../asset/images/founder-img2.png" alt="img">
                  <section>
                     <div class="sb-service-section2 bg-change2">
                        <h6>Mr. Seydou TUO</h6>
                        <p>Développeur Fulstack</p>
                     </div>
                     <div class="hover-type">
                        <a href="https://www.linkedin.com/in/tch%C3%A9r%C3%A9gnimin-seydou-tuo-6a99141b2/" class="d-inline-block w-100 text-center">Voir le profil</a>
                     </div>
                  </section>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
               <div class="sb-founder-section pt-5">
                  ...
                  <section>
                     <div class="sb-service-section2 bg-change2">
                        <h6>Mr Angelo Dago</h6>
                        <p>Developpeur BackEnd</p>
                     </div>
                     <div class="hover-type">
                        <a href="https://www.linkedin.com/in/angelo-dago-138b281a7/" class="d-inline-block w-100 text-center">Voir le profil</a>
                     </div>
                  </section>
               </div>
            </div>
   ...
   <div class="team-main-wrapper">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="sb-team-section">
                  <h6 class="home1-section-heading1">Notre équipe</h6>

            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#"><?php //echo $sub_title 
                                                                ?></a></li>
                        <li class="breadcrumb-item active"><?php //echo $sub_title 
                                                            ?></li>
                    </ol>
                </div>
                <h4 class="page-title"><?php //echo $sub_title 
                                        ?></h4>
            </div>
            <!--end page-title-box-->
        </div>
                    ...
                    <div class="table-responsive browser_users">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="assets/images/logos/micro-edge.png" alt="" height="20" class="me-2">Microsoft Edge
                                    </td>
                                ...
                                <tr>
                                    <td><img src="assets/images/logos/in-explorer.png" alt="" height="20" class="me-2">Internet-Explorer
                                    </td>
